    ...
    return (
      <ViewContainer>
        ...
        <div className="ProjectsContainer">
          <h3 className="ProjectsHeader">{content.home.projects.header}</h3>
          <div className="ProjectsBody">{content.home.projects.body}</div>
          <Row>
            <Col sm={6}>
          ...
          <Row>
            <Col sm={6}>
              <Carousel className="ProjectsCarousel" fade="true">
                {content.home.projects.old_robot.carousels.second.images.map(
                  (item, index) => (
            ...
            <Col sm={6}>
              <Carousel className="ProjectsCarousel" fade="true">
                {content.home.projects.current_robot.carousels.first.images.map(
                  (item, index) => (
                    <CarouselItem key={index}>
                      <div className="ProjectsImageContainer">
                        <Image src={item} folder="robots" />
